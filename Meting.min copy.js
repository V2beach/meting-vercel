...
class MetingJSElement extends HTMLElement {
  ...
  _init() {
    ...
    let b = [
      'server', 'type', 'id', 'api', 'auth', 'auto', 'lock', 'name', 'title',
      'artist', 'author', 'url', 'cover', 'pic', 'lyric', 'lrc'
    ];
    this.meta = {};
    ...
    this.config = a,
    this.api = this.meta.api || window.meting_api ||
        'https://meting.v2beach.cn/api/index?server=:server&type=:type&id=:id&r=:r',
  ...
  _parse_link() {
    ...
    for (var b = 0; b < a.length; b++) {
      ...
      if (null !== e)
        return this.meta.server = c[1], this.meta.type = c[2],
